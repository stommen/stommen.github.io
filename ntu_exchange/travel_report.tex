...
\begin{center}
    ...
    {\textbf{\noindent\hrulefill \hspace{1cm}{\HUGE T}{\huge RAVEL}\hspace{0.15cm} {\HUGE R}{\huge EPORT}}\hspace{1cm}\noindent\hrulefill} \\
    \vspace{0.5cm}
...
\newpage
\setcounter{page}{1}
\include{travel_report/intro}

\include{travel_report/preps}

\include{travel_report/life}

\include{travel_report/courses}

\include{travel_report/discovering}

\input{travel_report/appendix}
